drop table if exists users,categories,events,requests,compilations,compilation_event,user_vote;
...
CREATE TABLE user_vote(
 event_id INTEGER,
 user_id INTEGER,
 CONSTRAINT pk_user_vote PRIMARY KEY (event_id,user_id)
);
...
ALTER TABLE user_vote ADD FOREIGN KEY (event_id) REFERENCES events (id);
ALTER TABLE user_vote ADD FOREIGN KEY (user_id) REFERENCES users (id);
